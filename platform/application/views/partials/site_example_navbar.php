            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li<?php if ($segment_1 == 'playground' || $this->uri->segment(1) == 'playground') { ?> class="active"<?php } ?>><a href="<?php echo site_url('playground'); ?>"><i class="fa fa-sun-o"></i> The Playground</a></li>
