...
|--------------------------------------------------------------------------
*/
$config['copyright_note'] = 'Copyright &copy; 2012 - {year} Ivan Tcholakov and other contributors. License: <a href="http://opensource.org/licenses/MIT" target="_blank" rel="noopener">MIT</a>.'.(ENVIRONMENT != 'production' ? ' This page has been generated in <strong>{elapsed_time} seconds</strong> using <strong>{memory_usage}</strong> of memory.' : '');
...
|--------------------------------------------------------------------------
*/
$config['default_title'] = 'Application Starter 3 Public Edition';
